...
// TODO (by Alexander Graf) On my opinion this class is a huge waste
// of time.
...
final class Zystem {
    ...
    Zystem(int m) throws UnSupportedLoggerException {
        mode = m;
        startLogger("asdf");
    }
     ...
     * "gnu.io.log.mode". The available values are :<ul> <li> SILENT_MODE No
     * logging <li> FILE_MODE log to file <li> NET_MODE <li> MEX_MODE <li>
     * PRINT_MODE <li> J2EE_MSG_MODE <li> J2SE_LOG_MODE log to java.util.logging
     * </ul>
     */
    Zystem() throws UnSupportedLoggerException {
