 ...
 *
 * First, instances of
 * <code>SerialPortEventListener</code> are registered on a port using the
 * <code>SerialPort.addEventListener()</code> method. Then the desired events
 ...
 * <code>serialEvent</code> method of the listener is called with an event
