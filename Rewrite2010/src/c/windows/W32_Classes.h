...
#ifndef _W32_CLASSES_H_
#define _W32_CLASSES_H_
#include <windows.h>
...
class ParallelPortImpl : public ParallelPort
{
public:
    ParallelPortImpl(const char *portName, HANDLE hComm);
    ~ParallelPortImpl();
    void abort();
    void close();
...
{
public:
    SerialPortImpl(const char *portName, HANDLE hComm);
    ~SerialPortImpl();
    void abort();
    void close();
