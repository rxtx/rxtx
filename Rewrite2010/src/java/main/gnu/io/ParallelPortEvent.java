...
public class ParallelPortEvent extends EventObject {
    ...
    /**
     * Constructs a <CODE>ParallelPortEvent</CODE> with the specified parallel port, event
     * type, old and new values. Application programs should not directly create
     * <CODE>ParallelPortEvent</CODE> objects.
     * 
     * @param source
     * @param eventType
     * @param oldValue
     * @param newValue
     */
    public ParallelPortEvent(ParallelPort source, int eventType, boolean oldValue, boolean newValue) {
        super(source);
     ...
     * <CODE>ParallelPortEvent</CODE> to be propagated.
     * 
